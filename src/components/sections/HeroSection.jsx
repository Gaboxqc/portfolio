...
import TypewriterLoop from "../ui/TypewriterLoop.jsx";
import GradientButton from "../ui/GradientButton.jsx";
import {Link} from "react-router";
import {GithubIcon, LinkedInIcon, MailIcon} from "../../assets/icons/index.js";
    ...
    return (
        <section className={"h-screen bg-linear-to-br from-primary/20 via-transparent to-accent/20 text-white"}>
            <div
                ...
                <div
                    className={"mt-12 hidden items-center gap-2 rounded-3xl bg-muted-foreground/10 p-2 px-3 outline-1 md:flex"}>
                ...
                <div className={"flex gap-4"}>
                    ...
                    <Link to={"#contact"} className={"flex h-13 w-auto items-center justify-center rounded-lg px-4 " +
